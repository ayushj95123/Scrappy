...
const RegistrationForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.username) {
      ...
      validationErrors.username = 'Username must contain only alphanumeric characters';
    } else if (formData.username.length < 8 || formData.username.length > 30) {
      validationErrors.username = 'Username must be between 8 and 30 characters long';
    }
  ...
  return (
    <Box className="registrantion-form">
